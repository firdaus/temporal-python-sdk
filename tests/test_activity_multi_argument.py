...
TASK_QUEUE = "test_activity_multi_argument"
NAMESPACE = "default"


class GreetingActivities:
    @activity_method(task_queue=TASK_QUEUE, schedule_to_close_timeout=timedelta(seconds=1000))
    async def compose_greeting(self, arg1, arg2) -> str:
        raise NotImplementedError


class GreetingActivitiesImpl:

    async def compose_greeting(self, arg1, arg2):
        return arg1 + arg2
...
class GreetingWorkflowImpl(GreetingWorkflow):
    ...
    async def get_greeting(self):
        return await self.greeting_activities.compose_greeting("a", "b")
