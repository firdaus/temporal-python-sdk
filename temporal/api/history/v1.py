...
class WorkflowExecutionStartedEventAttributes(betterproto.Message):
    ...
    parent_workflow_execution: v1.WorkflowExecution = betterproto.message_field(3)
    parent_initiated_event_id: int = betterproto.int64_field(4)
    task_queue: v1.TaskQueue = betterproto.message_field(5)
    ...
    initiator: v1.ContinueAsNewInitiator = betterproto.enum_field(11)
    continued_failure: v1.Failure = betterproto.message_field(12)
    last_completion_result: v1.Payloads = betterproto.message_field(13)
    ...
    memo: v1.Memo = betterproto.message_field(22)
    search_attributes: v1.SearchAttributes = betterproto.message_field(23)
    prev_auto_reset_points: v1.ResetPoints = betterproto.message_field(24)
    header: v1.Header = betterproto.message_field(25)
...
class WorkflowExecutionFailedEventAttributes(betterproto.Message):
    ...
    retry_state: v1.RetryState = betterproto.enum_field(2)
...
class WorkflowExecutionTimedOutEventAttributes(betterproto.Message):
    retry_state: v1.RetryState = betterproto.enum_field(1)
...
class WorkflowExecutionContinuedAsNewEventAttributes(betterproto.Message):
    ...
    workflow_type: v1.WorkflowType = betterproto.message_field(2)
    task_queue: v1.TaskQueue = betterproto.message_field(3)
    ...
    initiator: v1.ContinueAsNewInitiator = betterproto.enum_field(9)
    failure: v1.Failure = betterproto.message_field(10)
    last_completion_result: v1.Payloads = betterproto.message_field(11)
...
class WorkflowTaskTimedOutEventAttributes(betterproto.Message):
    scheduled_event_id: int = betterproto.int64_field(1)
    started_event_id: int = betterproto.int64_field(2)
    timeout_type: v1.TimeoutType = betterproto.enum_field(3)
...
class WorkflowTaskFailedEventAttributes(betterproto.Message):
    scheduled_event_id: int = betterproto.int64_field(1)
    started_event_id: int = betterproto.int64_field(2)
    cause: v1.WorkflowTaskFailedCause = betterproto.enum_field(3)
...
class ActivityTaskStartedEventAttributes(betterproto.Message):
    ...
    last_failure: v1.Failure = betterproto.message_field(5)
...
class ActivityTaskFailedEventAttributes(betterproto.Message):
    ...
    started_event_id: int = betterproto.int64_field(3)
    identity: str = betterproto.string_field(4)
    retry_state: v1.RetryState = betterproto.enum_field(5)
...
class ActivityTaskTimedOutEventAttributes(betterproto.Message):
    ...
    scheduled_event_id: int = betterproto.int64_field(2)
    started_event_id: int = betterproto.int64_field(3)
    retry_state: v1.RetryState = betterproto.enum_field(4)
...
@dataclass
class CancelTimerFailedEventAttributes(betterproto.Message):
    timer_id: str = betterproto.string_field(1)
...
class WorkflowExecutionCancelRequestedEventAttributes(betterproto.Message):
    ...
    external_workflow_execution: v1.WorkflowExecution = betterproto.message_field(3)
    identity: str = betterproto.string_field(4)
...
class MarkerRecordedEventAttributes(betterproto.Message):
    ...
    workflow_task_completed_event_id: int = betterproto.int64_field(3)
    header: v1.Header = betterproto.message_field(4)
...
class WorkflowExecutionSignaledEventAttributes(betterproto.Message):
    ...
    input: v1.Payloads = betterproto.message_field(2)
    identity: str = betterproto.string_field(3)
...
class RequestCancelExternalWorkflowExecutionInitiatedEventAttributes(
    ...
    workflow_execution: v1.WorkflowExecution = betterproto.message_field(3)
...
class RequestCancelExternalWorkflowExecutionFailedEventAttributes(betterproto.Message):
    cause: v1.CancelExternalWorkflowExecutionFailedCause = betterproto.enum_field(1)
    workflow_task_completed_event_id: int = betterproto.int64_field(2)
    namespace: str = betterproto.string_field(3)
...
class SignalExternalWorkflowExecutionFailedEventAttributes(betterproto.Message):
    cause: v1.SignalExternalWorkflowExecutionFailedCause = betterproto.enum_field(1)
    workflow_task_completed_event_id: int = betterproto.int64_field(2)
    namespace: str = betterproto.string_field(3)
    workflow_execution: v1.WorkflowExecution = betterproto.message_field(4)
    initiated_event_id: int = betterproto.int64_field(5)
...
class UpsertWorkflowSearchAttributesEventAttributes(betterproto.Message):
    workflow_task_completed_event_id: int = betterproto.int64_field(1)
    search_attributes: v1.SearchAttributes = betterproto.message_field(2)
...
class StartChildWorkflowExecutionInitiatedEventAttributes(betterproto.Message):
    ...
    workflow_id_reuse_policy: v1.WorkflowIdReusePolicy = betterproto.enum_field(12)
    retry_policy: v1.RetryPolicy = betterproto.message_field(13)
    cron_schedule: str = betterproto.string_field(14)
    header: v1.Header = betterproto.message_field(15)
    memo: v1.Memo = betterproto.message_field(16)
    search_attributes: v1.SearchAttributes = betterproto.message_field(17)
...
class StartChildWorkflowExecutionFailedEventAttributes(betterproto.Message):
    ...
    workflow_id: str = betterproto.string_field(2)
    workflow_type: v1.WorkflowType = betterproto.message_field(3)
    cause: v1.StartChildWorkflowExecutionFailedCause = betterproto.enum_field(4)
...
class ChildWorkflowExecutionStartedEventAttributes(betterproto.Message):
    ...
    workflow_execution: v1.WorkflowExecution = betterproto.message_field(3)
    workflow_type: v1.WorkflowType = betterproto.message_field(4)
    header: v1.Header = betterproto.message_field(5)
...
class ChildWorkflowExecutionFailedEventAttributes(betterproto.Message):
    ...
    initiated_event_id: int = betterproto.int64_field(5)
    started_event_id: int = betterproto.int64_field(6)
    retry_state: v1.RetryState = betterproto.enum_field(7)
...
class HistoryEvent(betterproto.Message):
    ...
    event_type: v1.EventType = betterproto.enum_field(3)
    ...
    cancel_timer_failed_event_attributes: "CancelTimerFailedEventAttributes" = betterproto.message_field(
        25, group="attributes"
    )
